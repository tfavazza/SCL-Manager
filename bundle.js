...
/***/ function(module, exports, __webpack_require__) {
	...
	var onZipFileUpload = function onZipFileUpload(e) {
	  ...
	  api.zipFileUpload(formData).done(ui.zipFileUploadSuccess).fail(ui.zipFileUploadFailure);
	};

	var onDisplayPlayerSchedule = function onDisplayPlayerSchedule(event) {
	  event.preventDefault();
	  var player = event.target.id;
	  api.displayPlayerSchedule(player).done(ui.displayPlayerScheduleSuccess).fail(console.error);
	};

	var displayLeagueMembers = function displayLeagueMembers() {
	  $('.division-name').children().toggle();
	};

	var onDisplayAllSchedule = function onDisplayAllSchedule() {
	  api.displayAllSchedule().done(ui.showAllScheduleSuccess).fail(console.error);
	};
	...
	var getDate = function getDate() {
	  var convertedDate = new Date() - new Date().getTimezoneOffset();
	  var utc = Date(convertedDate).slice(0, 10);
	  return utc;
	};

	var onWeekOf = function onWeekOf() {
	  var utc = getDate();
	  var currentWeek = onGetCurrentWeek();
	  $("#week-date").html(utc + ': Week ' + currentWeek);
	};

	var onDisplayWeeklySchedule = function onDisplayWeeklySchedule() {
	  var leagueWeek = onGetCurrentWeek();
	  api.displayAWeek(leagueWeek).done(ui.displayThisWeeksSchedule);
	};

	var onGetCurrentWeek = function onGetCurrentWeek() {
	  var utcDay = new Date();
	  var today = utcDay - new Date().getTimezoneOffset();
	  var leagueWeek = (today - startDate) / 86400000;
	  leagueWeek = parseInt(Math.ceil(leagueWeek / 7));
	  return leagueWeek;
	};

	var onscrollUp = function onscrollUp() {
	...
	var onLastUpdated = function onLastUpdated() {
	  api.getLastUpdated().done(ui.displayLastUpdated).fail();
	};
	...
	module.exports = {
	  ...
	  getDate: getDate,
	  onGetCurrentWeek: onGetCurrentWeek
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getLastUpdated = function getLastUpdated() {
		return $.ajax({
	...
	var displayPlayerSchedule = function displayPlayerSchedule(player) {
		return $.ajax({
	...
	var displayAllSchedule = function displayAllSchedule() {
		return $.ajax({
	...
	var getGameRecap = function getGameRecap(id) {
		return $.ajax({
	...
	module.exports = {
		displayLeagueData: displayLeagueData,
		displayPlayerSchedule: displayPlayerSchedule,
		displayAllSchedule: displayAllSchedule,
		zipFileUpload: zipFileUpload,
		displayAWeek: displayAWeek,
		getGameRecap: getGameRecap,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var handleBarsLeague = __webpack_require__(8);
	var events = __webpack_require__(4);
	var handlebarsPlayer = __webpack_require__(28);
	var handebarsSchedule = __webpack_require__(29);
	var handlebarsWeek = __webpack_require__(30);
	var handlebarsConfirmation = __webpack_require__(31);
	var handlebarsRecap = __webpack_require__(32);
	var handlebarsRules = __webpack_require__(33);
	var handlebarsLastUpdated = __webpack_require__(34);
	var startDate = new Date('2017-05-13');

	var organizeFullSchedule = function organizeFullSchedule(rawSchedule) {
	    var fixedSchedule = {
	        "Week-1": [],
	        "Week-2": [],
	        "Week-3": [],
	    ...
	    for (var _i = 1; _i < 11; _i++) {
	        fixedSchedule["Week-" + _i][0]["weekdate"] = new Date(startDate.setDate(startDate.getDate() + 1)).toString().slice(3, 10) + ' \n        - ' + new Date(startDate.setDate(startDate.getDate() + 6)).toString().slice(3, 10);
	    }
	...
	var displayLeagueDataSuccess = function displayLeagueDataSuccess(data) {
	    var league = data.list.leagues;
	...
	var zipFileUploadFailure = function zipFileUploadFailure(response) {
	    ...
	    $('#confirmation').html('<div class="container"><div class="alert alert-info"> <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Oh no!</strong> Something went wrong! ' + error + '</div></div>');
	};
	...
	var showAllScheduleSuccess = function showAllScheduleSuccess(data) {
	    var schedule = organizeFullSchedule(data);
	...
	var displayGameRecap = function displayGameRecap(recap) {
	    $('#recap-results').html(handlebarsRecap(recap));
	    console.log(recap);
	};

	module.exports = {
	    displayLeagueDataSuccess: displayLeagueDataSuccess,
	    displayPlayerScheduleSuccess: displayPlayerScheduleSuccess,
	    showAllScheduleSuccess: showAllScheduleSuccess,
	    zipFileUploadSuccess: zipFileUploadSuccess,
	    zipFileUploadFailure: zipFileUploadFailure,
	    displayThisWeeksSchedule: displayThisWeeksSchedule,
	    displayRules: displayRules,
	    displayGameRecap: displayGameRecap,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "	<div class=\"panel panel-primary col-md-12 col-sm-12 .lead\">\r\n		<span style=\"cursor: pointer\" class=\"panel-primary\" data-toggle=\"collapse\" href=\"#collapse"
	    ...
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "\">		\r\n"
	    + ((stack1 = helpers.each.call(alias1,(depth0 != null ? depth0.players : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "		</div>\r\n	</div>\r\n";
	},"2":function(container,depth0,helpers,partials,data) {
	    var helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

	  return "			<div class=\"panel-heading h3 alt-color container-fluid\" role=\"tab\" id=\"heading"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "\">\r\n				<span class=\"col-md-1 col-md-offset-0 col-sm-1 col-sm-offset-0 col-xs-2 col-xs-offset-2 flag-icon flag-icon-"
	    ...
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "\r\n				</div>\r\n				<div class=\"col-md-2 col-sm-2 col-xs-3\">Score "
	    ...
	    + "</div>\r\n				<div class=\"col-md-2 col-sm-2 col-xs-3\">Wins "
	    ...
	    + "</div>\r\n				<div class=\"col-md-2 col-sm-2 col-xs-3\">Losses "
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<blockquote>\r\n	<div class=\"alt-color\">Week "
	    + alias2(alias1((depth0 != null ? depth0.week : depth0), depth0))
	    + ": <span class=\"flag-icon flag-icon-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.player1 : depth0)) != null ? stack1.country : stack1), depth0))
	    + "\"></span> <b>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.player1 : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</b> against <span class=\"flag-icon flag-icon-"
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<ul class=\"list-group h3\">\r\n  <li class=\"list-group-item list-group-item-info\">\r\n    Post all replays to <u><a href=\"https://secure.spyparty.com/beta/forums/posting.php?mode=reply&f=10&t=2657\" target=\"_blank\">this thread</a></u> so that games can be recorded! PLEASE use the results tag to avoid spoilers! We prefer it if you tell us who picked and banned what maps.\r\n  </li>\r\n  <li class=\"list-group-item list-group-item-info\">\r\n      Games may be played at any time during the assigned week.\r\n  </li>\r\n  <li class=\"list-group-item list-group-item-info\">\r\n    It is encouraged, but not mandatory, to schedule games for Sunday evenings, Pacific time, during the live cast.\r\n  </li>\r\n  <li class=\"list-group-item list-group-item-info\">\r\n    Use <u><a href=\"http://draftmeaspy.party/\" target=\"_blank\">draftmeaspy.party</a></u> to set up your matches, pick/ban maps, choose who spies/snipes first, etc.!\r\n  </li>\r\n  <li class=\"list-group-item list-group-item-info\">\r\n  The live cast is every Sunday, 6:00pm US Pacific, at <u><a href=\"twitch.tv/spyparty\" target=\"_blank\">http://twitch.tv/spyparty</a></u>, with a pre-show starting at 5:30pm.\r\n  </li>\r\n  <li class=\"list-group-item list-group-item-info\">\r\n    You can and should schedule games weeks in advance.\r\n  </li>\r\n  <li class=\"list-group-item list-group-item-info\">\r\n    You must schedule games promptly and respond to your opponents' attempts to schedule games.\r\n  </li>\r\n  <li class=\"list-group-item list-group-item-info\">Full scheduling, rules, and current league standings can be found in the League thread on the forums, as well as here.\r\n</li>\r\n<li class=\"list-group-item list-group-item-info\"><b>Overtime Rules</b> <br>When overtime begins, the last player who played spy picks ANY map, and ANY possible layout of time, missions, and partygoers. The other player then elects to spy or snipe and the game is played. Then the players switch - the other player chooses any map/layout, and the first player then chooses to spy or snipe. If one player wins both these games, they win overtime. If the player split the overtime games, the match ends in a draw.\r\n</li>\r\n</ul>\r\n\r\n<div class=\"h3\">List of Maps</div>\r\n\r\n<ul class=\"list group\">\r\n<li class=\"list-group-item list-group-item-info col-lg-2 col-md-3 col-sm-12\">\r\nBalcony ANY 2/3 <br></li>\r\n  <li class=\"list-group-item list-group-item-info  col-lg-2 col-md-3 col-sm-12\">\r\nBalcony PICK 2/3  <br></li>\r\n  <li class=\"list-group-item list-group-item-info  col-lg-2 col-md-3 col-sm-12\">\r\nNew Art Ballroom ANY 4/8 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info  col-lg-2 col-md-3 col-sm-12\">\r\nNew Art Ballroom ANY 4/7 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info  col-lg-2 col-md-3 col-sm-12\">\r\nCourtyard ANY 4/6 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info  col-lg-2 col-md-3 col-sm-12\">\r\nCourtyard ANY 4/7 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info  col-lg-2 col-md-3 col-sm-12\">\r\nCourtyard 2 ANY 4/6 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info  col-lg-2 col-md-3 col-sm-12\">\r\nCourtyard 2 ANY 4/7 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info  col-lg-2 col-md-3 col-sm-12\">\r\nDouble Modern ANY 3/5 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info  col-lg-2 col-md-3 col-sm-12\">\r\nDouble Modern Known 2 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info  col-lg-2 col-md-3 col-sm-12\">\r\nGallery ANY 4/7 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info  col-lg-2 col-md-3 col-sm-12\">\r\nGallery ANY 4/8 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info  col-lg-2 col-md-3 col-sm-12\">\r\nHigh-rise ANY 3/5 <br><br><br> </li>\r\n  <li class=\"list-group-item list-group-item-info col-lg-2 col-md-3 col-sm-12\">\r\nHigh-rise ANY 4/8 (12 Guests, 3 min)<br><br> </li>\r\n  <li class=\"list-group-item list-group-item-info col-lg-2 col-md-3 col-sm-12\">\r\nModern ANY 2/3 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info col-lg-2 col-md-3 col-sm-12\">\r\nModern PICK 2/3 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info col-lg-2 col-md-3 col-sm-12\">\r\nPanopticon ANY 5/7 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info col-lg-2 col-md-3 col-sm-12\">\r\nPanopticon ANY 5/8 <br> </li>\r\n  <li class=\"list-group-item list-group-item-info col-lg-2 col-md-3 col-sm-12\">\r\nPub ANY 3/5 (3:15) </li>\r\n  <li class=\"list-group-item list-group-item-info col-lg-2 col-md-3 col-sm-12\">\r\nPub ANY 4/7 (16 guests)  </li>\r\n  <li class=\"list-group-item list-group-item-info col-lg-2 col-md-3 col-sm-12\">\r\nNew Art Veranda ANY 5/7  </li>\r\n  <li class=\"list-group-item list-group-item-info col-lg-2 col-md-3 col-sm-12\">\r\nNew Art Veranda ANY 5/8</li>\r\n</ul>\r\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div>Last Game Uploaded: "
	    + alias2(alias1((depth0 != null ? depth0.player1 : depth0), depth0))
	    + " vs "
	    + alias2(alias1((depth0 != null ? depth0.player2 : depth0), depth0))
	    + "</div>\r\n";
	},"useData":true});
